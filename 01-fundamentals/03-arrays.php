...
// We can also do arrays within arrays:
$many_arrays = array(
  array("first_name" => "Tim", "last_name" => "Knab"),
  array("first_name" => "Julianna", "last_name" => "Giles"),
);

echo "<p>" . $many_arrays[0]["first_name"] . "</p>";

// You may notice that if you simply try and echo your array, you'll get a debugging error. Instead, try using "var_dump" to see the contents of your variable like this:
var_dump($many_arrays);
var_dump($my_ski_things);
?>
