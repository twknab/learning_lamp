...
$route['users/edit/admin/info'] = 'user/admin_update_info';
$route['users/edit/admin/password'] = 'user/admin_update_pass';
...
// $route['books'] = 'book/dashboard';
// $route['books/(:num)'] = 'book/view/$1';
// $route['books/add'] = 'review/add';
// $route['review/new'] = 'review/create';
// $route['review/book/new'] = 'review/quick_create';
// $route['review/delete/(:num)/(:num)'] = 'review/delete/$1/$2';
